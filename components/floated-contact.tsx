...
export default function FloatingContact() {
  ...
  const contactOptions = [
    ...
    },
    {
      icon: Mail,
      label: "Email",
      href: "mailto:info@allinroof.com",
    ...
    },
    {
      ...
      color: "bg-[#018dc8] hover:bg-[#018dc8]/80",
      delay: "delay-450",
    },
  ]
  ...
  return (
    <div ref={containerRef} className="fixed bottom-6 left-6 z-50">
      ...
      <button
        ...
        className={cn(
          "relative flex items-center justify-center w-14 h-14 bg-[#018dc8] hover:bg-[#018dc8]/80 text-white rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 focus:outline-none",
          isOpen ? "rotate-45" : "",
        )}
        aria-label="Contact"
      >
        {/* Pulse Effect */}
        <div className="absolute inset-0 rounded-full bg-[#018dc8] animate-ping opacity-75"></div>
        <div className="absolute inset-0 rounded-full bg-[#018dc8] animate-pulse opacity-50"></div>
